...
pub fn DeployStages(total: i64) -> impl IntoView {
    ...
    view! {
        <div class="my-6 inline-flex items-center gap-4 rounded-lg border border-line bg-paper-2 p-4">
            <button
                class="rounded bg-ink px-3 py-1 font-mono text-paper hover:bg-accent"
