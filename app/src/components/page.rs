...
/// the 44rem reading column. The home listing and the post article compose
/// their own masthead into it directly; [`Page`] adds the heading on top for
...
/// [`PageShell`] plus a title and the heading: the about and 404
